...
const planetDetails = {
  ...
  Earth: "Earth is the only known planet with life, with vast oceans and landmasses.",
  Mars: "Mars is known as the Red Planet due to its iron oxide-rich surface.",
  Jupiter: "Jupiter is the largest planet, famous for its Great Red Spot storm.",
  Saturn: "Saturn is adorned with stunning rings made of ice and rock.",
  Uranus: "Uranus rotates on its side and has a bluish-green color due to methane.",
...
document.addEventListener("click", (e) => {
  ...
  if (panel.classList.contains("show") && !panel.contains(e.target) && !e.target.closest(".mercury, .venus, .earth, .mars, .jupiter, .saturn, .uranus, .neptune, .pluto")) {
